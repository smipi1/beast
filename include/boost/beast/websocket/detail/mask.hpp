        ...
        std::uint32_t& key)
{
    ...
    if(n >= sizeof(key))
    {
        ...
        switch(i)
        {
        case 1: p[2] ^= byte_at(key, 2); BOOST_BEAST_FALLTHROUGH;
        case 2: p[1] ^= byte_at(key, 1); BOOST_BEAST_FALLTHROUGH;
    ...
    switch(n)
    {
    case 3: p[2] ^= byte_at(key, 2); BOOST_BEAST_FALLTHROUGH;
    case 2: p[1] ^= byte_at(key, 1); BOOST_BEAST_FALLTHROUGH;
        ...
        std::uint64_t& key)
{
    ...
    if(n >= sizeof(key))
    {
        ...
        switch(i)
        {
        case 1: p[6] ^= byte_at(key, 6); BOOST_BEAST_FALLTHROUGH;
        case 2: p[5] ^= byte_at(key, 5); BOOST_BEAST_FALLTHROUGH;
        case 3: p[4] ^= byte_at(key, 4); BOOST_BEAST_FALLTHROUGH;
        case 4: p[3] ^= byte_at(key, 3); BOOST_BEAST_FALLTHROUGH;
        case 5: p[2] ^= byte_at(key, 2); BOOST_BEAST_FALLTHROUGH;
        case 6: p[1] ^= byte_at(key, 1); BOOST_BEAST_FALLTHROUGH;
    ...
    switch(n)
    {
    case 7: p[6] ^= byte_at(key, 6); BOOST_BEAST_FALLTHROUGH;
    case 6: p[5] ^= byte_at(key, 5); BOOST_BEAST_FALLTHROUGH;
    case 5: p[4] ^= byte_at(key, 4); BOOST_BEAST_FALLTHROUGH;
    case 4: p[3] ^= byte_at(key, 3); BOOST_BEAST_FALLTHROUGH;
    case 3: p[2] ^= byte_at(key, 2); BOOST_BEAST_FALLTHROUGH;
    case 2: p[1] ^= byte_at(key, 1); BOOST_BEAST_FALLTHROUGH;
    case 1: p[0] ^= byte_at(key, 0);
